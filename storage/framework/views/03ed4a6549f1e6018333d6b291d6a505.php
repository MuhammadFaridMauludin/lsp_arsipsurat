  ...
  <div class="container-xl">
    <div class="card">
      <div class="card-body">
        ...
        <embed src="<?php echo e(asset('storage/' . $arsip->file)); ?>" type="application/pdf" width="100%" height="600px">
...
<?php echo $__env->make('layouts.admin.tabler', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Muhammad Farid M\Downloads\absensigeotaggingandselifievideo\absensita\resources\views/arsip/show.blade.php ENDPATH**/ ?>