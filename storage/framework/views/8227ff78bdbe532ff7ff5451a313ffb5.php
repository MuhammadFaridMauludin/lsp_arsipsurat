                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium"><?php echo e($totalkaryawan); ?></div>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium"><?php echo e($rekappresensi->jmlhadir); ?></div>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium"><?php echo e($rekapizin->jmlizin != null ? $rekapizin->jmlizin : 0); ?></div>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium"><?php echo e($rekapizin->jmlsakit != null ? $rekapizin->jmlsakit : 0); ?></div>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium"><?php echo e($rekappresensi->jmlterlambat); ?></div>
...
<?php echo $__env->make('layouts.admin.tabler', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Muhammad Farid M\Downloads\absensigeotaggingandselifievideo\absensita\resources\views/dashboard/dashboardadmin.blade.php ENDPATH**/ ?>